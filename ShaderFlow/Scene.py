...
class ShaderScene(ShaderModule):
    ...
    def main(self,
        ...
        vcodec:     Annotated[str,   Option("--vcodec",     "-c", help="(🟢 Exporting) Video Codec: 'h264, h264-nvenc, h265, hevc-nvenc, vp9, av1-{aom,svt,nvenc,rav1e}'")]="h264",
        acodec:     Annotated[str,   Option("--acodec",     "-a", help="(🟢 Exporting) Audio Codec: 'aac, mp3, opus, flac, copy, none, empty'")]="copy",
