# TEMPORARY CODE GOT FROM A PULL REQUEST BEFORE A NEW MODERNGL-WINDOW VERSION IS RELEASED.
# https://github.com/moderngl/moderngl-window/pull/197
# https://github.com/moderngl/moderngl-window/pull/196
