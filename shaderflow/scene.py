...
class ShaderScene(ShaderModule):
    ...
    typer: BrokenTerminal = Factory(lambda: BrokenTerminal(chain=True))
    """This Scene's BrokenTerminal instance for the CLI. Commands are added by any module in the
    ...
    def init_window(self) -> None:
        ...
        backend = ("egl" if BrokenSystem.OnLinux and eval(os.getenv("WINDOW_EGL", "1")) else None)
    ...
    def main(self,
        ...
        progress:   Annotated[Optional[Callable[[int, int], None]], BrokenTerminal.exclude()]=None,
        # Implementation of batch exporting
        _reference: Annotated[Tuple[int, int], BrokenTerminal.exclude()]=None,
        _index:     Annotated[int,  BrokenTerminal.exclude()]=None,
        _started:   Annotated[str,  BrokenTerminal.exclude()]=None,
        _outputs:   Annotated[Path, BrokenTerminal.exclude()]=None,
    ) -> Optional[List[Path]]:
        """
