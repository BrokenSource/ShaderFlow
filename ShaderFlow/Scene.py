...
class ShaderScene(ShaderModule):
    ...
    def main(self,
        ...
        scale:      Annotated[float, Option("--scale",      "-x", help="[bold][red](🔴 Basic  )[/red][/bold] Post-multiply Width and Height by a Scale Factor [medium_purple3](None to keep)[/medium_purple3] [dim](1.0 on init, raw scale)[dim]")]=None,
        ...
        time:       Annotated[float, Option("--end",        "-t", help="[green](🟢 Export )[/green] The duration of exported videos [dim](Loop duration)[/dim] [medium_purple3](defaults to 10 or longest module's duration)[/medium_purple3]")]=None,
        ...
        format:     Annotated[str,   Option("--format",     "-F", help="[green](🟢 Export )[/green] Output Video Container: One of [green]('mp4', 'mkv', 'webm', 'avi, '...')[/green] [yellow](Overrides --output one)[/yellow]")]="mp4",
